...
class BinarySearchTree {
    ...
    insert(newVal) {
        ...
        if (prev.data > newVal) {
            prev.left = new BSTNode(newVal)
        } else prev.right = new BSTNode(newVal);
    }
...
const fourLevelTree = new BinarySearchTree();
fourLevelTree.insertRecursive(10)
fourLevelTree.insertRecursive(5)
fourLevelTree.insertRecursive(15)
fourLevelTree.print()
